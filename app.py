...
{keyword_guideline}
6. 다음 표현들은 사용 금지: "눈에 띄게 발전했습니다", "인상적입니다", "돋보입니다", "기대됩니다", "충분히 가능하다고 생각합니다". 더 구체적이고 신선한 표현을 쓰세요.
